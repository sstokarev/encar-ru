...
owns = ["src/calc/customs.ts", "src/calc/specs.ts", "test/calc.test.ts", "test/specs.test.ts", "scripts/build-catalog.mjs", "site/specs-catalog.json", "src/page/lot.ts", "test/page-lot.test.ts"]
